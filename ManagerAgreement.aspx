        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12">
                <form class="container-form text-white" runat="server">
                    <h2 class="text-center mb-3">Manager Approval</h2>
...
<div class="mb-3 row">
                        ...
                        <div class="col-sm-7">
                            <asp:TextBox ID="ManagerTextBox" CssClass="form-control" placeholder="Document ID" runat="server"></asp:TextBox>
                        </div>
                        <div class="col-sm-3">
                            <asp:Button ID="ManagerButton" CssClass="btn btn-primary btn-block" runat="server" Text="Search" Width="250px" />
                        </div>
                    </div>
...
<asp:GridView ID="ManagerDisplayDatabase" runat="server" Width="80%">            </asp:GridView> 
