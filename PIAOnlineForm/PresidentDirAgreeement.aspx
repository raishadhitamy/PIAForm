        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12">
                <form class="container-form text-white" runat="server">
                    <h2 class="text-center mb-3">President Director Approval</h2>
...
<div class="mb-3 row">
                        ...
                        <div class="col-sm-7">
                            <asp:TextBox ID="PreTextBox" CssClass="form-control" placeholder="Document ID" runat="server"></asp:TextBox>
                        </div>
                        <div class="col-sm-3">
                            <asp:Button ID="PreButton" CssClass="btn btn-primary btn-block" runat="server" Text="Search" Width="250px" />
                        </div>
                    </div>
...
<asp:GridView ID="PreDisplayDatabase" runat="server" Width="80%">            </asp:GridView> 
