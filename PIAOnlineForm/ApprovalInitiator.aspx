        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12">
                <form class="container-form text-white" runat="server">
                    ...
                    <asp:GridView ID="DisplayDatabase" runat="server" Width="91%" BackColor="#FCE1E4" BorderColor="#C1BBDD" BorderStyle="Solid" ForeColor="#90639E" Font-Names="Times New Roman" Font-Size="Large">
