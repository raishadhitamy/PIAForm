...
<div class="mb-3 row">
                        ...
                        <div class="col-sm-7">
                            <asp:TextBox ID="MatTextBox" CssClass="form-control" placeholder="Document ID" runat="server"></asp:TextBox>
                        </div>
                        <div class="col-sm-3">
                            <asp:Button ID="MatButton" CssClass="btn btn-primary btn-block" runat="server" Text="Search" Width="250px" />
                        </div>
                    </div>
