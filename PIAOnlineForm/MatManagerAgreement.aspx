...
<body class="bg">
    ...
    <nav>
        ...
        <ul>
            ...
            <li><a href="MatManagerAgreement.aspx">Approval</a></li>
            <li><a href="FullDataMatManager.aspx">Full Data</a></li>
            ...
            <div class="col-md-12 col-sm-12">
                <form class="container-form text-white" runat="server">
                    ...
                    <div class="mb-3 row justify-content-center">
                        <asp:Button ID="Button1" CssClass="btn btn-block mt-4" runat="server" Text="Show the full data" Width="308px" BackColor="#C1BBDD" BorderColor="#C1BBDD" Font-Names="Arial" Font-Size="Large" ForeColor="White" />
                    </div>

                    <br />

                      <asp:GridView ID="MatDisplayDatabase" runat="server" Width="100%" BackColor="White" BorderColor="#C1BBDD" Font-Names="Arial" Font-Size="Large" ForeColor="#90639E">
...
<asp:TemplateField><ItemTemplate>
                 ...
                 <div class="col-sm-3">
                      <asp:RadioButtonList ID="mat_mgr_approval" runat="server" Font-Names="Arial" Font-Size="Large">
                    ...
                    <asp:Button ID="MatBtnUpdate" CssClass="btn btn-primary btn-block mt-4" runat="server" Text="Update" Width="308px" BackColor="#C1BBDD" BorderColor="#C1BBDD" Font-Names="Arial" Font-Size="Large" />
